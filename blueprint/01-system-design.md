...
| Backend API | Điểm vào chính cho web/PWA, xác thực, phân quyền, rate limit và điều phối các domain module. |
...
|---|---|---|
| HTTP/REST | Web/PWA gọi Backend API; Backend API gọi payment provider khi cần phản hồi đồng bộ. | Dễ debug, phù hợp request-response. |
