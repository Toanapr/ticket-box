...
Trong vài phút đầu mở bán, lượng người dùng và request giữ vé có thể tăng đột ngột. Autoscale phản ứng sau khi tải tăng thường không đủ nhanh, còn database không thể scale write vô hạn.
...
2. Gateway/edge rate limit request theo IP, user, device và endpoint.
...
- **Chỉ autoscale:** phản ứng chậm và không bảo vệ database.
