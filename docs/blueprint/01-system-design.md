...
|---|---|
| Frontend | Next.js cho audience web, admin web và scanner PWA. |
| Backend | NestJS modular monolith, tách NestJS worker process cho notification, import, AI và reconciliation. |
