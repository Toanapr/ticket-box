...
Tài liệu này chia TicketBox thành các phase có thể tiến hành tuần tự. Hướng triển khai mặc định là NestJS modular monolith, worker process riêng, PostgreSQL, Redis, RabbitMQ, MinIO và Keycloak. Các module vẫn giữ boundary rõ để có thể tách service sau này nếu có tải thật.
