  ...
  return (
    <PageShell>
      <div className="rounded-lg border border-black/10 bg-white p-10 text-center">
        <h1 className="font-display text-3xl font-black">Khong tim thay trang</h1>
        <p className="mt-3 text-slate-600">Duong dan nay khong ton tai trong audience web.</p>
