...
export function HeroSpotlight({
  ...
  return (
    <section className="mb-12 grid gap-8 border-b-2 border-ticket-obsidian pb-12 lg:grid-cols-[1fr_340px] lg:items-center">
      <div
        key={concert.id}
        className="motion-safe:[animation:spotlight-in_450ms_ease-out]"
      >
        ...
        {spotlightConcerts.length > 1 ? (
          <div
            ...
            aria-label="Điều khiển concert nổi bật"
          >
      ...
      <div
        key={`${concert.id}-poster`}
        className="relative aspect-square overflow-hidden rounded-lg border border-black/10 bg-slate-100 shadow-sm motion-safe:[animation:spotlight-poster_500ms_ease-out]"
      >
        <ConcertPoster
