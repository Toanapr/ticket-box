...
export class TicketService {
  ...
  async getTicket(userId: string, ticketId: string) {
    ...
    return {
      ...
      concertId: ticket.ticketType.concertId,
      concertTitle: ticket.ticketType.concert.title,
      venue: ticket.ticketType.concert.venue,
      startsAt: ticket.ticketType.concert.startAt,
